...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        */
        ArrayList<String> listDoubledTrippled = new ArrayList<String>();

        for (int i = 0; i < list.size(); i++)
        {
            String s = list.get(i);
            listDoubledTrippled.add(s);
            listDoubledTrippled.add(s);
            if (s.length() % 2 != 0)
            {
                listDoubledTrippled.add(s);
        ...
        for (int i = 0; i < listDoubledTrippled.size(); i++) System.out.println(listDoubledTrippled.get(i));
    }
}
