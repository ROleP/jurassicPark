...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        try
        {
            ...
            reader.close();
        //} catch (IOException e) {}
        if (Planet.SUN.equals(s)) thePlanet = Sun.getInstance();
        else if (Planet.MOON.equals(s)) thePlanet = Moon.getInstance();
        else if (Planet.EARTH.equals(s)) thePlanet = Earth.getInstance();
        else thePlanet = null;
        } catch (IOException e) {}
    }
}
