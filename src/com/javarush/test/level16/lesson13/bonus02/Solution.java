...
public class Solution {
    ...
    static
    {
        threads.add(new Class001());
        threads.add(new Class002());
        threads.add(new Class003());
        threads.add(new Class004());
        threads.add(new Class005());
    }

    public static class Class001 extends Thread
    {
        public void run()
        {
            while (true) {}
    ...
    public static class Class002 extends Thread
    {
        public void run()
        {
            try
    ...
    public static class Class003 extends Thread
    {
        public void run()
        {
            try
    ...
    public static class Class004 extends Thread implements Message
    {
    ...
    public static class Class005 extends Thread
    {
        public int sum = 0;
        ...
        public void run()
        {
            ...
            catch (InterruptedException e) {System.out.println(sum);}
        }
    }
}
*/
