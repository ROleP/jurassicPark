...
public class Solution
{
    ...
    static class Person
    {
        ...
        Person(String name)
        {
            ...
            //Add your code here
            Random random = new Random(1123762);
            allMoney.add(new Hrivna(random.nextInt(9999) + Math.floor(random.nextDouble() * 100) * 1.0d / 100));
            allMoney.add(new USD(random.nextInt(9999) + Math.floor(random.nextDouble() * 100) * 1.0d / 100));
        }
