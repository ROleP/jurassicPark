...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        {
            if (apartament instanceof Apt1Room) ((Apt1Room) apartament).clean1Room();
            if (apartament instanceof Apt2Room) ((Apt2Room) apartament).clean2Rooms();
            if (apartament instanceof Apt3Room) ((Apt3Room) apartament).clean3Rooms();
        }
    }
