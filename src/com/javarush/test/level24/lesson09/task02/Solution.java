    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int diff;
                diff = ((String)(stock1.get("name"))).compareTo((String)(stock2.get("name")));
                if (diff == 0)
                {
                    ...
                    if (diff == 0)
                    {
                        ...
                        if (stock1.containsKey("change"))
                            ch1 = (Double)stock1.get("change");
                        else
                            ch1 = (Double)stock1.get("last") - (Double)stock1.get("open");
                        if (stock2.containsKey("change"))
                            ch2 = (Double)stock2.get("change");
                        else
                            ch2 = (Double)stock2.get("last") - (Double)stock2.get("open");
                        diff = ch1.compareTo(ch2);
                    }
                }
                return diff;
            }
